...
%
\item[]  RESPONSE:  Yes, this is what we observe for example with Alpha Centauri b, where the correlation gamma -- SN RV is positive. When working with simulations and in particular for the case of a facula, we measured a negative gamma -- SN RV correlation. This might be cause by some of the limitations about SOAP 2.0 described in Section 7, and an interesting point for improving the software in the future.
