...
Regarding the cancelation of the correlation between gamma and SN mean RV between spots and faculae, we do believe that faculae would take over and therefore create a positive correlation. If we compare the gamma - SN mean RV correlation in Figure 3 and 6, indeed the amplitude in gamma and RV are similar, 

This positive correlation is seen in all the stars in the Appendix. This is because the faculae over spot ratio on the Sun is about 10 (Chapman-2001). If we compare the correlation between 
