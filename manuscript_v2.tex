...
%%%   \caption{Comparison between the Normal (black circles) and the SN (red pluses) residuals using CCF's from the star Alpha Centauri B (left) and Corot-7 (right). When looking at the residuals corresponding to the center of the CCF, the SN fit leads to slightly better results for both stars.} %Moreover, as the SNR decreases, the SN density shows smaller residuals respect the Normal ones.}
