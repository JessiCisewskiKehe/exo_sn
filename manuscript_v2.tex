...
In order to make the result of the simulations more comparable to real data obtained with the HARPS spectrograph discussed in Sect.~\ref{sec:4}, the SOAP 2.0 CCFs were generated with a width of 40 \kms\, and considering initial spectra with resolution of R=115'000. {\bf We consider a simplified setting with a single spot or a single facula in order to isolate the effects of an active region on the various activity measures.}
