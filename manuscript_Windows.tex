...
%
In Sec.~\ref{sec:31} we propose an expanded linear model used to correct the estimated RVs from the inferred stellar activity, which extends the linear models previously proposed for this purpose \citep{Dumusque:2017aa,Feng:2017aa}. 
%
