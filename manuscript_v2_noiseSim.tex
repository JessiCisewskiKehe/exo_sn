...
In particular, we considered issues with correlations between the model covariates, which can lead to issues because the matrix needed to calculate the estimates could be singular; this problem is known in statistics as \textit{multicollinearity} and more discussion can be found in \citet{belsley1991}.
