...
By using Eq. \ref{eq:snd_cp}, the new set of parameters $(\mu, \sigma^2, \gamma)$ provides a more clear interpretation of the behavior of the SN distribution. In particular, $\mu$ and $\sigma^2$ are the actual mean and the variance of the distribution (rather than simply a location and scale parameter), and $\gamma$ becomes an index for evaluating the asymmetry of the SN. 
%
