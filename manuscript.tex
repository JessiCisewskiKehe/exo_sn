...
The correlations are weaker than in the case of the spot due to the planet inducing changes in RV without affecting the width or asymmetry of the CCF.  However, the strength of the correlations between the CCF asymmetry and RV are in the same order as with the spot-only model: $\gamma$--SN median RV, BIS SPAN--N mean RV and $\gamma$--SN mean RV, with $R$ values of $-0.84$, $-0.78$ and $-0.76$, respectively. 
The variation seen in the width-RV phase space draw a circle like in the case of a spot, therefore, no correlation is observed between those two parameters.
