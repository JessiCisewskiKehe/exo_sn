...
All the covariates are statistically significant to explain the variability in RV's caused by a spot, except the intercept and the width of the CCF.
...
All the covariates are statistically significant to explain the variability in RV's caused by a spot, except the FWHM.
