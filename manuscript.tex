...
The Skew Normal (SN) distribution, introduced by \cite{Azzalini1985}
...
, is a class of probability distributions which includes the Normal distribution as a special case. The SN distribution has, in addition to a position and a scale parameter, a third parameter which describes the asymmetry of the distribution. 
