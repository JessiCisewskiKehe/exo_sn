...
\umberto{trying to understand why we get better results for P=20 days when using the usual correction}
...
US was partially supported by Fondazione CARIPARO. \umberto{check if there is a code or something}
%-----------------------------------------------------------------------------------------------------------------------------------------------
%\section{Appendix}
\appendix
