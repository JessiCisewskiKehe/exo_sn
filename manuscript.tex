...
\jessi{[My suggested revision] These three stars include measurements that cover the range of SNR measured at 550 nm (SNR550) from 10 to 500, which represent a very low SNR and the saturation limit of the HARPS detector, respectively.
HD10700 and Alpha Cen B were not included because they have a large number of measurements, which would require a substantial computational effort.}
...
\xavier{The conclusion found for the SOAP 2.0 simulations that the correlation between the CCF asymmetry and the estimated RV, as well as between the CCF width and the estimated RV, is stronger for the SN than the Normal parameters also holds when analyzing real data.
} \jessi{I mildly revised Xavier's statement}
%
