...
For a given configuration of spots and faculae on the stellar surface, SOAP 2.0 outputs simulated CCF as a function of rotational phase. The code also returns the RV and the FWHM estimated using a Normal model for the CCF, and the BIS SPAN obtained by calculating the bisector of the CCF. 
