...
In this paper, a new approach for quantifying shape changes in the CCF is proposed using the SN density, which can be used to estimate the RV, and the width and skewness of the CCF. 
...
In the different tests carried out for this work, the SN parameters performed at least as well as (and often times better than) the parameters from the Normal approach and the BIS SPAN.
...
$\text{HD}215152$ and Corot-7 have on average a lower SNR at 550 nm than HD10700 and HD192310. The average SNR at 550 nm for the stars \text{HD}10700, \text{HD}192310, $\text{HD}215152$ and Corot-7 are respectively 273, 207, 141 and 44.
