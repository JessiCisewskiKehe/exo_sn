...
However, once corrected for stellar activity using the linear combination presented in Eq.~\ref{eq:RV:correction}, as shown in the bottom plots of Fig~\ref{fig:alphacent:correctionRV}, the rms of the residuals are essentially the same for all three approaches.
...
Instead, we go to the individual spectra where the individual measurements can be considered independent from the other points.
...
These three stars include measurements that cover the range of SNR measured at 550 nm (SNR550) from 10 to 500, which represent a very low SNR and the saturation limit of the HARPS detector, respectively. 
...
The authors also thank Yale's Center for Research Computing for their help and resources with some of the computational aspects of this work.
