...
The RV variations displayed in Fig.~\ref{fig:faculae} are caused only by stellar activity, in this case a facula, so we applied the activity correction proposed in Eq.~\ref{eq:RV:correction} to evaluate the performance of the model in this setting.
