...
{We strongly encourage the use of the SN densitty to retrieve the different parameters of the CCF since the correlations used to probe stellar activity are stronger than the ones retrieved by the common approach and because the estimation of RV and CCF asymmetry parameters are more precise.
}
