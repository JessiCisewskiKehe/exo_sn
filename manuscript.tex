...
\end{table}
%
Further details about the parametrization from Eq.~\ref{def:snd_gen}, called the \emph{Direct Parametrization} (DP), the CP, and general statistical properties of the SN can be found in \cite{Azzalini2014}.
