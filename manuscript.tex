...
\xavier{This interaction term can accounts for possible interactions between SN FWHM (or FWHM) and $\gamma$ (or BIS SPAN), meaning that the two variables' association with the response, $RV_{\text{activity}}$, depends also on the other variable.
