...
For each of the 4500 simulations we derived at first the corresponding three set of RV, namely N mean RV, SN mean RV and SN median RV. Then, the proposed model from Eq.~\eqref{eq:RV:correction.overall} was fit. 
