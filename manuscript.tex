...
For all the stars considered in the presented work, only CCFs that were derived from spectra that had at least a SNR at 550 nm of 10 were selected. 
...
\subsection{Comparison between the different CCF parameters derived with the Normal and the Skew Normal} \label{sec:alphacentb}
...
The selected observations should represent the best sampled and most precise RV data set available for Alpha Centauri B \jessi{I added ``Alpha Centauri B'' - if the previous statement was to be more general, please remove} showing strong solar-like activity signal \citep{Thompson-2017, Dumusque-2012}.
