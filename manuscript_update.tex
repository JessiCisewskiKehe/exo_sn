...
%\umberto{here were discussed the implementation of the heteroskedastic function for the variance and the second run once removed the residuals median. Both these steps won't be in the new analyses.}
%%%%%% April 5th, 2018
%%% in the new Analyses both the heteroskedastic function for the variance and the second run are not considered
%%%%%%
\iffalse
...
To test the strength of the correlation between RVs and the different activity indicators, we calculated the Pearson correlation coefficient, $R$.
...
%\umberto{here the correction for stellar activity was discussed. In the new analyses we are using the median of the SN as indicator for RV of the star.}
%%%%%% April 5th, 2018
%%% in the new Analyses both the is no correction for stellar activity: the median of the SN is used
%%%%%%
\iffalse
...
When the Normal fit is used, the parameter $\gamma$ is replaced by the BIS SPAN and SN FWHM by FWHM. In order to show the goodness of this correction, a statistical test on the parameters $\beta_{0}$, $\beta_{1}$ and $\beta_{2}$ is presented, where the null hypothesis is $H_{0}: \beta_{i}=0$, for $i=0,1,2$. \jessi{the estimated values and p-values of the $\beta$'s does \underline{not} show goodness of fit.}
The level for not rejecting the null hypothesis is fixed equal to $0.05$. Pearson correlation coefficient $R^{2}$ is considered for explaining how well this linear combination explains the variability of the RVs of the star due to stellar activity. \jessi{$R^2$ is the coefficient of determination, and this should be explained better because it is not commonly used in astronomy as an assessment of the amount of variability explained by the model.}
\fi
%%%%%%
%%%
%%%%%% April 5th, 2018
...
%%%%%%April 5th, 2018
%%% correction for stellar activity
%%%%%%
\iffalse
...
\begin{figure*}[htbp]
   \centering
\includegraphics[height = 4in]{HD12862_[3]CorrectionActivity_RadialVelocity_vs_time.pdf} 
...
\hline
 $\text{HD}192310  $          &    $1576$    & $0.883$ & $0.812$ & $0.682 (0.655; 0.707)$ & $0.33 (0.285; 0.373)$  & $-0.335 (-0.378; -0.29)$ & $0.677 (0.650; 0.703)$ & $0.475 (0.436; 0.513)$\\
\hline
 $\text{HD}10700 $            &    $7928$    & $0.795$ & $0.749$ & $0.436 (0.418; 0.454)$ & $-0.073 (-0.095; -0.0051)$ & $0.127 (0.105; 0.148)$ & $0.291 (0.270; 0.311)$ & $0.529 (0.513; 0.545)$ \\
\hline
 $\text{HD}215152 $          &     $273$   &  $ 0.763$ & $0.794$ & $0.571 (0.485; 0.646)$ & $-0.067 (-0.184; 0.052)$  & $0.269 (0.155; 0.376)$ & $0.210 (0.094; 0.321)$ & $-0.138 (-0.253; -0.020)$ \\
\hline
 $\text{Corot }7$     &     $173$    &  $0.797$  & $0.64$ & $0.561 (0.450; 0.656)$ & $0.092 (-0.058; 0.238)$ & $-0.335 (-0.228; -0.082)$ & $-0.709 (0.626;0.776)$ & $0.595 (0.489; 0.683)$ \\
\hline
\end{tabular}
}
